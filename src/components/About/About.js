                ...
                <h1 style={{fontSize: '2em', fontWeight: 'bold', paddingTop: '80px', textAlign: 'center'}}>About</h1>
                    <div className='column'>
                        ...
                        <div className='right'>
                            ...
                            <h3>Ryan Carman</h3>
                            <a href="mailto: carmanrn@mail.uc.edu">carmanrn@mail.uc.edu</a>
                            <h3>Sam Dappen</h3>
                            <a href="mailto: dappensd@mail.uc.edu">dappensd@mail.uc.edu</a>
                            <h3>Braeden Huth</h3>
                            <a href="mailto: huthbn@mail.uc.edu">huthbn@mail.uc.edu</a>
                            <h3>Hayes Kennedy</h3>
                            <a href="mailto: kenne2jh@mail.uc.edu">kenne2jh@mail.uc.edu</a>
                            <h3>Nathan Phillips</h3>
                            <a href="mailto: phillin4@mail.uc.edu">phillin4@mail.uc.edu</a>
                            </div>
                        </div> 
                    </div>      
            </div>
